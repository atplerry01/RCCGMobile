...
export default class OnlinePay extends Component {
    ...
    onlinePaymentPlatform() {
        const { amount, parishItem, myParishDetail, userData } = this.state;
        ...
        if (parishItem && parishItem !== 'Select Payment Item') {
            this.registerPayment(userData, amount, myParishDetail.divisionCode, parishItem);
        } else {
    ...
    async refreshScreen() {
        // const { userData, myParishDetail } = this.state;
        // this.getParishItems(myParishDetail.divisionCode, userData);
    ...
    async componentDidMount() {
        ...
        // if (myParishDetailStore && myParishDetailStore !== 'none') {
        //     const myParishDetailStore1 = JSON.parse(myParishDetailStore);
        //     const myParishDetail = JSON.parse(myParishDetailStore1);
        //     this.setState({ myParishDetail })
        // }

        // if (myParishItemsStore && myParishItemsStore !== 'none') {
        //     const myParishItemsStore1 = JSON.parse(myParishItemsStore);
        //     const myParishItems = JSON.parse(myParishItemsStore1);

        //     if (myParishItems.length < 1) {
